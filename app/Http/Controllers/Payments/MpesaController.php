...
class MpesaController extends Controller
{
    ...
    {
        $request->validate([
            'phone' => ['required', 'string', 'regex:/^254(7|1)[0-9]{8}$/']
        ], [
            'phone.required' => 'Please enter your MPesa number.',
            'phone.regex' => 'Invalid phone number format. Use 254 followed by 9 digits (e.g., 254712345678 for Safaricom or 254112345678 for Airtel).'
        ]);
